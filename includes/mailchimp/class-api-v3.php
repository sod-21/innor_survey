...
class MQZ_API_V3 {
	...
	public function __construct( $api_key ) {
		$this->client = new MQZ_API_V3_Client( $api_key );
	}

	/**
	 * Gets the API client to perform raw API calls.
	 *
	 * @return MQZ_API_V3_Client
	 */
	...
	public function put_list_merge_fields( $list_id, array $args = array() ) {
		$resource = sprintf( '/lists/%s/merge-fields', $list_id );
